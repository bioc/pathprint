...
###################
# single.chip.enrichment - function to assess erichment of gene sets using various statistics
...
# normalizedScore - if statistic = "mean" uses parametric method to assign a significance score
...
##################
{
  ...
  if((normalizedScore == TRUE & !(statistic == "mean"))) stop("Parameteric normalization can only be used for statistic = mean")
